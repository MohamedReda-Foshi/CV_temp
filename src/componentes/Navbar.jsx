  ...
  const handClickPc=()=>
    {
      ...
      if(Open) {
        setMessage(<GiHamburgerMenu className="text-white bg-black dark:bg-white dark:text-black" size={30} />)
      } else {
        setMessage(<IoMdClose size={30} className="text-white bg-black dark:bg-white dark:text-black" />)
